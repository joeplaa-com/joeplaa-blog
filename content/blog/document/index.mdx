...
What I also learned was that [I really like to design and build systems](what-i-learned-from-migrating-our-websites/). In this case the [systems that run our software](hosting-asp-net-apps-on-aws/), but I also remember that given the chance, I will also start building systems for people to work together more efficiently. In effect those systems are a company. And the nice thing is, it also happens to be something that I’m good at.
